...
public class LoginAdmin extends javax.swing.JDialog implements VistaLogin {
  ...
  private void LoginAdmBtnActionPerformed(
    ...
    if (!LoginAdmUser.getText().equals("") ||
        !LoginAdmPass.getText().equals("")) {
      controlador.validarLoginAdmin(Integer.parseInt(LoginAdmUser.getText()),
                                    LoginAdmPass.getText());
    } else {
