...
public class ControladorBonificaciones implements Observador {
  ...
  public ControladorBonificaciones(VistaBonificacion vista,
                                   Administrador admin) {
  ...
  private void mostrarBonificaciones() {
    ...
    ArrayList<TipoBonificacion> tipos =
        Fachada.getInstancia().getTipoBonificaciones();
  ...
  public void asignarBonificacion(Propietario propietario, String nombrePuesto,
                                  String tipoBonificacion) {
    try {
      Bonificacion bonif =
          Fachada.getInstancia().asignarTipoBonificacion(tipoBonificacion);
