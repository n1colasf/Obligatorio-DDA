...
public class Propietario extends Usuario {
    ...
    public void agregarAsignacion(Asignacion a) {
        ...
        a.getAdministrador().avisar(Administrador.eventos.cambiosListaBonificaciones);
    ...
    public void agregarRecarga(Recarga r) throws PeajeException {
        if (r.getMonto() >= 1) {
            ...
            Fachada.getInstancia().avisarAdminsConectados(Administrador.eventos.cambioListaRecargas);
        } else {
